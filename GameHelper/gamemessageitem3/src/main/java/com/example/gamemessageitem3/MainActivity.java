package com.example.gamemessageitem3;
...
//        setviewHeigh(holder.itemView,60);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {//注意是子布局进行监听,而不是子控件
            @Override
...
//                setviewHeigh(view,height);
            }
        });
        animator.start();
    }
    public  void setviewHeigh(View view,int heigh){
